...
namespace BTG
{
	...
	public class PlayerBaseState : BaseState<Player.State>
	{
		...
		public PlayerBaseState(FiniteStateMachine<Player.State> fsm, Player player, PlayerData data, int animId) : base(fsm)
		{
			this.player = player;
			this.data = data;
			this.animId = animId;
		...
		public override void OnExit() { } // => player.Anim.SetBool(animId, false);
		...
		*/
		...
		public override void OnPhysicsUpdate() => OnCheck();
