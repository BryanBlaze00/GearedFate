...
namespace BTG
{
	...
	{
		public PlayerHeatWave(FiniteStateMachine<Player.State> fsm, Player player, PlayerData data, int animId) : base(fsm, player, data, animId)
		{
		...
		public void BlastWave() => player.BlastHeatWave();
