...
namespace BTG
{
    ...
    public class PlayerData : ScriptableObject
    {
        ...
        [field: SerializeField]
        public float DashForce { get; private set; } = 8;

        [field: SerializeField]
        public float DashCoolDown { get; private set; } = 1;

        [field: SerializeField]
        public float DashTime { get; private set; } = 0.1f;

        [field: SerializeField]
        public float SlashDamage { get; private set; } = 5f;

        [field: SerializeField]
        public float SlashRadius { get; private set; } = 0.5f;
        ...
        [field: SerializeField]
        public float HitSpinChargeUpTime { get; private set; } = 1f;

        [field: SerializeField]
        public float MaxAttackFuelAmount { get; private set; } = 50;

        [field: SerializeField]
        public float GearShootCoolDown { get; private set; } = 1f;

        [field: SerializeField]
        public float GearFuelBurnAmount { get; private set; } = 0.5f;
        ...
        [field: SerializeField]
        public float FireBlazeDPS { get; private set; } = 30;

        [field: SerializeField]
        public float FireBlazeBurnRate { get; private set; } = 5;

        [field: SerializeField]
        public float HitStunTime { get; private set; } = 0.5f;
