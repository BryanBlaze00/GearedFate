...
namespace BTG
{
	...
	public class PlayerData : ScriptableObject
	{
		...
		[field: SerializeField] public float Health { get; private set; } = 50;
		...
		[field: SerializeField, InfoBox("This is set after calculating the slash animation duration", EInfoBoxType.Normal)] 
