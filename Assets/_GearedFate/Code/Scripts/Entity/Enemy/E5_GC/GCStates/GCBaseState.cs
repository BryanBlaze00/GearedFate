...
namespace BTG
{
	...
	public abstract class GCBaseState : BaseState<GreatCreator.GreatCreatorState>
	{
		...
		public GCBaseState(FiniteStateMachine<GreatCreator.GreatCreatorState> fsm, GreatCreator enemy, int animId) : base(fsm)
		{
			GreatCreator = enemy;
			_animId = animId;
			SetSpawnTime();
		...
		protected void SetSpawnTime()
		{
			...
			_nextSpawnTime = _lastSpawnTime + Random.Range(GreatCreator.SwarmCoolDown.Min, GreatCreator.SwarmCoolDown.Max);
		}
