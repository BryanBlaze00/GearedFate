...
namespace BTG
{
	...
	public class ObjectToPoolInfo
	{
		...
		[field: SerializeField, Range(2, 100)] public int AmountToPool { get; private set; }
	...
	public class ObjectPool : Singleton<ObjectPool>
	{
		...
		void ObjectPoolItemToPooledObject(PooledObjectType type)
		{
			ObjectToPoolInfo item = objectsToPool[type];
