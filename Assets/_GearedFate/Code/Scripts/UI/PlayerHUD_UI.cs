...
namespace BTG
{
    ...
    public class PlayerHUD_UI : MonoBehaviour
    {
        ...
        [SerializeField]
        private Image _downCD;
        [SerializeField]
        private Image _leftCD;
        [SerializeField]
        private Image _rightCD;
        [SerializeField]
        private Image _topSelected;
        [SerializeField]
        private Image _botSelected;
        [SerializeField]
        private Image _leftSelected;
        [SerializeField]
        private Image _rightSelected;
        [SerializeField]
        private Image _topSelectedCD;
        [SerializeField]
        private Image _botSelectedCD;
        [SerializeField]
        private Image _leftSelectedCD;
        [SerializeField]
        private Image _rightSelectedCD;
        [SerializeField]
        private TextMeshProUGUI _gearTossCDText;
        [SerializeField]
        private TextMeshProUGUI _heatWaveCDText;
        [SerializeField]
        private TextMeshProUGUI _slashCDText;
        [SerializeField]
        private TextMeshProUGUI _fireBlazeCDText;
