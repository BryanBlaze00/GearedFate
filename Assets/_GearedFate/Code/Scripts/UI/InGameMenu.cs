        ...
        private void ToggleMenu(InputAction.CallbackContext obj)
        {
            ...
            if (_menuOpened)
            {
                ...
                Sequence.Create(1, CycleMode.Restart, 0f, true)
                    ...
                    .Group(Tween.Rotation(_GearTwo.transform, _GearTwo.rotation.eulerAngles + new Vector3(0, 0, 120f),
                        0.3f));

                Sequence.Create(1, CycleMode.Restart, 0f, true)
                    .Group(Tween.UIAnchoredPosition(_GearOne, new Vector2(0, 65), 1f))
                    .Group(Tween.Rotation(_GearOne.transform, _GearOne.rotation.eulerAngles + new Vector3(0, 0, 120f),
                        0.3f));
            ...
            else
            {
                ...
                Sequence.Create(1, CycleMode.Restart, 0f, true)
                    ...
                    .Group(Tween.Rotation(_GearTwo.transform, Quaternion.Euler(0, 0, 0), 1f, Ease.Default, 1,
                        CycleMode.Incremental));

                Sequence.Create(1, CycleMode.Restart, 0f, true)
                    .Group(Tween.UIAnchoredPosition(_GearOne, new Vector2(200, 45), 1f))
                    .Group(Tween.Rotation(_GearOne.transform, Quaternion.Euler(0, 0, 0), 1f, Ease.Default, 1,
                        CycleMode.Incremental));
