namespace DayenCreation
{
    ...
    public static class CreateScriptFromTemplates
    {
        ...
        private const string COPYRIGHT = "//\n// Copyright (c) " + PLACEHOLDERRNS + ". All rights reserved.\n//";
        ...
        {
            var path = ROOTPATH + "MonoBehaviour.txt";
        ...
        {
            var path = ROOTPATH + "ScriptableObject.txt";
        ...
        {
            var path = ROOTPATH + "Interface.txt";
        ...
        {
            var path = ROOTPATH + "FiniteState.txt";
        ...
        private static void GenerateFile(string path, string fileName, int fileIndex)
        {
            if (!FilesUpdated[fileIndex])
            {
                ...
                copyright = copyright.Replace(PLACEHOLDERRNS, rootNamespace);

                string templateContent = File.ReadAllText(path);
                templateContent = templateContent.Replace(PLACEHOLDERCR, copyright);
